...
class MessageInput extends StatefulWidget {
  ...
  MessageInput(
      {Key? key,
        ...
        this.typingCallback,
        this.focusNode,
        this.maxLines,required this.sendphoto,required this.sendaudio,required this.sendvideo})
      : super(key: key);
        ...
        child: Padding(
            ...
            child: Row(
              children: [
                ...
                Padding(
                    padding: EdgeInsets.only(left: 8,right: 50.w),
